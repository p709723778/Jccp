...
@implementation GYUncaughtExceptionHandler
...
void HandleException(NSException *exception)
{
    ...
    NSArray             *callStack = [GYUncaughtExceptionHandler backtrace];
    ...
    [[[GYUncaughtExceptionHandler alloc] init]
